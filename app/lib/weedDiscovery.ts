...
export const lcWeedOwner: WeedOwnerConfig = {
  ...
  guides: [
    { label: "Lakeshore Visit Guide", description: "How to find 1720 Lakeshore Rd W from Port Credit, Clarkson, and Lakeshore West.", href: "/visit" }, { label: "Menu Guide", description: "Compare flower, pre-rolls, edibles, vapes, concentrates and other cannabis formats.", href: "/resources/menu-guide" }, { label: "Weed & Flower Guide", description: "Find more context before choosing a Weed flower collection.", href: "/resources/weed-flower-guide" }, { label: "Value Guide", description: "Understand value-oriented choices without relying on a current price or promotion.", href: "/resources/value-guide" }, { label: "Pre-Roll Guide", description: "Focus specifically on the pre-roll format.", href: "/resources/pre-roll-guide" },
  ],
};
