/**
 * Tier-page schema contract (MJ01 reference, adapted for LC01).
 *
 * SITE_ORIGIN must stay identical to STORE_IDENTITY.websiteUrl / homepage WebSite+Store @ids.
 ...
 *
 * Flower tier owners on this store: /exotic /premium /aaa /aa /budget
 * Live *-weed aliases render the same page and keep the short-path canonical.
 * Do not 301/308 the short SCC owners onto *-weed.
 */
export const SITE_ORIGIN = "https://www.highcoastalcannabis.com";
