...
export const CATEGORY_CONFIG: Record<string, CategoryInfo> = {
  EDIBLES: {
    ...
    seoIntro: "Browse the full cannabis edibles menu at High Coastal Cannabis on Mississauga St, Mississauga. We carry THC gummies, chocolates, drinks, and more from top Canadian brands.",
    seoDescription: "Looking for cannabis edibles in Mississauga? High Coastal Cannabis stocks a wide range of THC-infused gummies, chocolates, beverages, and baked goods. Our edibles range from micro-dose options for beginners to high-potency products for experienced consumers. All products are lab-tested and sourced from licensed Canadian producers. Visit us at 1720 Lakeshore Rd W — open daily 24 hours.",
    faqs: [
      ...
      { q: "Can I buy edibles at High Coastal Cannabis?", a: "Yes! Visit us at 1720 Lakeshore Rd W, Mississauga. We're open daily 24 hours with a full edibles selection in store." },
    ],
  },
  "VAPE PENS": {
    banner: "/banners/01_Vape_Pens.webp",
    name: "THC Vape", slug: "vapes", color: "#8b5cf6", icon: "💨",
    seoTitle: "Vape Pens Mississauga — THC & Nicotine Cartridges",
    seoIntro: "Shop THC and nicotine vape pens at High Coastal Cannabis, Mississauga. Cartridges, 510-thread batteries, and premium vape brands — all in stock.",
    seoDescription: "High Coastal Cannabis carries a curated selection of vape pens and cartridges in Mississauga. From 510-thread THC cartridges to nicotine vape pods, we stock the most popular brands and flavours. Our knowledgeable budtenders can help you choose the right cartridge and battery setup. Visit us at 1720 Lakeshore Rd W for the best vape selection in ByWard Market.",
    faqs: [
  ...
  "VAPE DISPOSABLE": {
    ...
    seoTitle: "Disposable Vapes Mississauga — THC Disposable Pens",
    seoIntro: "THC disposable vapes available at High Coastal Cannabis, Mississauga. No charging, no refilling — just open and enjoy.",
    seoDescription: "Disposable THC vapes are the easiest way to enjoy cannabis on the go. High Coastal Cannabis stocks a wide selection of pre-charged, pre-filled disposable vape pens with various strain profiles and potencies. Perfect for beginners and experienced users alike. Visit us at 1720 Lakeshore Rd W, Mississauga.",
    faqs: [
  ...
  CONCENTRATES: {
    ...
    seoTitle: "Cannabis Concentrates Mississauga — Shatter, Wax, Hash & Live Resin",
    seoIntro: "Premium cannabis concentrates at High Coastal Cannabis, Mississauga. Shatter, wax, hash, live resin, and diamonds — all in stock.",
    seoDescription: "High Coastal Cannabis offers a premium selection of cannabis concentrates in Mississauga. From traditional hash and kief to modern extracts like shatter, wax, live resin, and THC diamonds, we carry products for every preference and potency level. Our concentrates are sourced from trusted extractors and tested for purity. Visit us at 1720 Lakeshore Rd W.",
    faqs: [
  ...
  PREROLLS: {
    ...
    seoIntro: "Pre-rolled cannabis joints at High Coastal Cannabis, Mississauga. Singles, multi-packs, and infused pre-rolls — ready to light up.",
    seoDescription: "Skip the rolling and grab a pre-roll from High Coastal Cannabis in Mississauga. We carry singles, multi-packs, and infused pre-rolls from premium flower. Whether you want a quick smoke or a party pack, our pre-roll selection has something for everyone. Visit us at 1720 Lakeshore Rd W — open daily 24 hours.",
    faqs: [
  ...
  "ADD ONS": {
    ...
    seoTitle: "Cannabis Accessories Mississauga — Grinders, Papers, Lighters & More",
    seoIntro: "Essential cannabis accessories at High Coastal Cannabis, Mississauga. Grinders, rolling papers, lighters, trays, and more.",
    seoDescription: "High Coastal Cannabis carries all the accessories you need for the perfect smoke session. From premium grinders and rolling papers to lighters, trays, and storage containers, we have everything in stock. Visit us at 1720 Lakeshore Rd W, Mississauga.",
    faqs: [
  ...
  CIGARETTES: {
    ...
    seoTitle: "Native Cigarettes Mississauga — Discount Tobacco at High Coastal Cannabis",
    seoIntro: "Discount native cigarettes at High Coastal Cannabis, Mississauga. Premium and value brands at the best prices on Mississauga St.",
    seoDescription: "High Coastal Cannabis is your go-to source for affordable native cigarettes in Mississauga. We carry a wide selection of premium and value tobacco brands at competitive prices. Located at 1720 Lakeshore Rd W in the heart of ByWard Market, we're open daily 24 hours. Stop by for the best cigarette prices in the neighbourhood.",
    faqs: [
      { q: "Do you sell cigarettes at High Coastal Cannabis?", a: "Yes! We carry a wide selection of native cigarette brands at competitive prices." },
  ...
  "MAGIC & OTHERS": {
    ...
    seoTitle: "Magic Mushrooms & More — Mississauga",
    seoIntro: "Magic mushrooms, psilocybin products, and specialty items at High Coastal Cannabis, Mississauga.",
    seoDescription: "High Coastal Cannabis carries a curated selection of magic mushrooms and specialty products in Mississauga. From micro-dose capsules to dried psilocybin mushrooms, we stock products for both beginners and experienced psychonauts. Visit us at 1720 Lakeshore Rd W for our full selection.",
    faqs: [
