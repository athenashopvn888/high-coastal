  ...
  BUDGET: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "Budget flower starts at just $3 per gram. Value ounces start from $40 — some of the best prices you'll find in Mississauga. Our 3g bundle pricing applies here too, giving you even more savings.",
      },
    ],
    faqs: [
