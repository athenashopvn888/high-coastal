...
export const TIER_SEO: Record<string, TierSeoData> = {
  ...
  BUDGET: {
    ...
    seoIntro: "Cheap weed in Mississauga starting at $3/g. High Coastal Cannabis Budget tier features shreds and value ounces for cost-conscious smokers. Open daily on Mississauga St.",
    sections: [
      {
