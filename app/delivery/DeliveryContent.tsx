...
export default function DeliveryContent() {
  ...
  return <main className={styles.main}>
    ...
    <div className={styles.ctaSection}><p>Visit us in-store at <strong>1720 Lakeshore Rd W, Mississauga</strong>. We are <strong>open 24 hours</strong>. Call <strong>(289) 401-7550</strong>.</p></div>
