...
export default function HighCoastalWebChat() {
  ...
  useEffect(() => {
    const initial = window.setTimeout(() => {
      if (token) void refresh(token).catch(() => setNotice("Your previous High Coastal Cannabis chat could not be restored."));
