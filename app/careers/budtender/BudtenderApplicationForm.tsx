...
const requiredFields = [
  ...
  { name: "WhyQLC", label: "Why you want to work at High Coastal" },
...
export default function BudtenderApplicationForm() {
  ...
  return (
    <form className={styles.applicationForm} onSubmit={handleSubmit} noValidate>
      <input type="hidden" name="StoreKey" value="LC01" />
      <input type="hidden" name="StoreName" value="High Coastal Cannabis" />
      ...
      <div className={styles.formSection}>
        ...
        <label className={styles.field}>
          <span>Why do you want to work at High Coastal Cannabis?</span>
