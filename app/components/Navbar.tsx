...
const ALL_LINKS: { href: string; label: string; featured?: boolean }[] = [
  ...
  { href: "/native-cigarettes-lakeshore", label: "Native Cigarettes" },
  { href: "/nicotine-vape-lakeshore", label: "Nic Vape Lakeshore" },
  ...
  return (
    <nav className={styles.navbar} id="main-nav">
      <div className={styles.topBar}>
        <Link href="/" className={styles.logo} aria-label="High Coastal Cannabis" style={{ display: "flex", alignItems: "center", gap: "8px", textDecoration: "none" }}>
