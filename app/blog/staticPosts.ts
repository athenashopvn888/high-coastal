...
export const STATIC_POSTS: StaticBlogPost[] = [
  {
    ...
    "title": "How to Plan a High Coastal Cannabis Visit Without Guessing",
    "seoTitle": "High Coastal Cannabis Visit Guide | Weed Dispensary in Mississauga",
    "seo_title": "High Coastal Cannabis Visit Guide | Weed Dispensary in Mississauga",
    "metaDescription": "Plan a Mississauga visit to High Coastal Cannabis with a clear shopper checklist for store details, menu categories, current listings, and staff questions.",
    "meta_description": "Plan a Mississauga visit to High Coastal Cannabis with a clear shopper checklist for store details, menu categories, current listings, and staff questions.",
    "h1": "How to Plan a High Coastal Cannabis Visit Without Guessing",
    "excerpt": "A practical visit guide for High Coastal Cannabis, written for shoppers who want the next step without the runaround.",
  ...
  },
  {
    ...
    "seoTitle": "High Coastal Cannabis Flower Guide | Budget to Exotic",
    "seo_title": "High Coastal Cannabis Flower Guide | Budget to Exotic",
    "metaDescription": "Compare High Coastal Cannabis flower sections with natural guidance for cheap weed, budget weed, premium flower, exotic flower, and current menu checks.",
    "meta_description": "Compare High Coastal Cannabis flower sections with natural guidance for cheap weed, budget weed, premium flower, exotic flower, and current menu checks.",
    "h1": "How to Compare High Coastal Cannabis Flower Without Guessing",
    "excerpt": "A shopper-first flower guide for comparing Budget, AA, AAA+, Premium, and Exotic sections at High Coastal Cannabis.",
    "authorName": "Marina High",
    "authorHandle": "@MarinaCoastal",
    "authorRole": "House Writer",
    "author": "Marina High",
  ...
  },
  {
    ...
    "seoTitle": "High Coastal Cannabis Menu Guide | Mississauga Weed Store",
    "seo_title": "High Coastal Cannabis Menu Guide | Mississauga Weed Store",
    "metaDescription": "Shop the High Coastal Cannabis menu with a simple shopper-first guide to flower, pre-rolls, edibles, THC vapes, concentrates, and current listings.",
    "meta_description": "Shop the High Coastal Cannabis menu with a simple shopper-first guide to flower, pre-rolls, edibles, THC vapes, concentrates, and current listings.",
    "h1": "How to Shop the High Coastal Cannabis Menu Like a Pro",
    "excerpt": "A natural guide to shopping the High Coastal Cannabis menu without turning the visit into a guessing game.",
    "authorName": "Kai Coastal",
    "authorHandle": "@KaiHighCoastal",
    "authorRole": "House Writer",
    "author": "Kai Coastal",
