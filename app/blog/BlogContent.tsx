...
const STATIC_POSTS = [
  ...
  },
  {
    ...
    title: "Why High Coastal Cannabis is Mississauga's Best Dispensary",
  ...
  },
  {
    ...
    title: "Mississauga Cannabis Laws in 2026 — What You Need to Know",
    excerpt: "Age limits, public consumption rules, possession limits, and where you can legally smoke in Mississauga. Stay informed.",
    date: "2026-04-25",
    category: "News",
    emoji: "⚖️",
    readTime: "4 min",
...
/* ── Google Reviews ── */
const REVIEWS = [
  { name: "Mike R.", rating: 5, text: "Best dispensary in the Mississauga area. Staff is super knowledgeable and the exotic strains are legit fire.", date: "2 weeks ago" },
...
export default function BlogContent() {
  ...
  useEffect(() => {
    fetch(`${APPS_SCRIPT_URL}?action=blog&store=LC01`)
      .then((r) => r.json())
    ...
    <main className={styles.main}>
      ...
      <section style={{ width: "100%", overflow: "hidden", marginTop: "92px" }}>
        <img
          ...
          alt="High Coastal Cannabis Blog"
      ...
      <section className={styles.hero}>
        <div className={styles.heroInner}>
          <h1 className={styles.heroH1}>
            📝 High Coastal Cannabis <span className={styles.heroAccent}>Blog</span>
          </h1>
          <p className={styles.heroSub}>
            Cannabis guides, strain reviews, and dispensary news from Mississauga&apos;s
            premium dispensary.
          </p>
        </div>
      </section>
