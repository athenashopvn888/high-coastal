"""
High Coastal Cannabis - Auto Sync from Google Sheets
==========================================
...
a filtered menu for High Coastal Cannabis (ALC01).
...
def main():
    print("=" * 60)
    print(f"  High Coastal Cannabis - Product Sync (Store: {STORE_CODE})")
    print("=" * 60)
    print()
    ...
    if do_deploy:
        ...
        if result.returncode == 0:
            print("  [OK] Live at https://highcoastalcannabis.com")
        else:
            print(f"  Output:\n{result.stdout[-500:]}")
    else:
