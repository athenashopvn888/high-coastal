"""
High Coastal Cannabis — Product Update Script
===================================
Drop your ONHAND CSV into the high-coastal folder as "onhand.csv" and run:
...
def main():
    ...
    if not os.path.exists(csv_path):
        print("=" * 60)
        print("  High Coastal Cannabis — Product Updater")
        print("=" * 60)
        print()
    ...
    if ans in ("y", "yes"):
        ...
        print("\n  [OK] Deployed! Check https://highcoastalcannabis.com")
    else:
